...
\begin{itemize}[nosep]
	...
	\item {\bf refereeHash:} 叔引用列表的序列化 $\rlp$ 序列，由叔块的 256 比特 Keccak 哈希构成，正式表达为 $\head_o \in\Byte^*$。
	该列表最多由 $\numberofommers$ 个叔块的哈希标识组成。
